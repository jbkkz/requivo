...
This is a fact about pyright's inference, discovered while closing #271 (one of three such facts that
surfaced fixing that issue; see `0005-the-typed-generation-seam.md` for the others). Nothing in this
