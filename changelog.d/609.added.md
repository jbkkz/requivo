- Added `gtm_brief` (#609), the go-to-market perimeter's one artifact per #607's cost rule —
  `requivo gtm_brief <slug>` generates it and `requivo docs <slug>` offers it alongside the
